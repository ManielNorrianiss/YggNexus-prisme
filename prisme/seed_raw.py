...
FICHES = [
    # --- lot 50 (2026-06-19/20) : sites bloques ou fiches maigres ---
    {
        "slug": "udio",
        "name": "Udio",
        "vendor": "Udio",
        "website_url": "https://www.udio.com",
        "raw_title": 'Udio - AI music generation',
        "raw_meta_desc": 'Udio is an AI music generation tool that creates full songs with vocals and instrumentation from text prompts.',
        "raw_text": 'Udio is an AI music creation platform that generates complete, studio-quality songs from simple text prompts. Users describe a genre, mood, topic or lyrics and Udio produces tracks with realistic vocals, instrumentation and song structure. It supports extending clips, remixing and fine-grained control over style, making it popular with hobbyists, content creators and musicians who want to prototype musical ideas quickly.',
        "categories": ["ai-audio"],
    ...
    },
    {
        ...
        "raw_title": 'Adobe Podcast - AI audio recording and enhancement',
        "raw_meta_desc": 'Adobe Podcast offers AI-powered tools to record, transcribe and enhance speech audio, removing noise and improving clarity.',
        "raw_text": 'Adobe Podcast is a suite of AI audio tools for creators and podcasters. Its flagship Enhance Speech feature removes background noise and echo to make voice recordings sound as if they were captured in a professional studio. The platform also provides browser-based multitrack recording, transcript-based editing and AI tools that speed up post-production, lowering the barrier to high-quality spoken-audio content.',
        "categories": ["ai-audio"],
        "primary_category": "ai-audio",
    },
    {
        ...
        "raw_title": 'Magnific AI - AI image upscaler and enhancer',
        "raw_meta_desc": 'Magnific AI is an advanced AI image upscaler and enhancer that adds detail and resolution to images and renders.',
        "raw_text": 'Magnific AI is an advanced image upscaler and enhancer that increases resolution while adding realistic new detail to photos, illustrations and 3D renders. Beyond simple upscaling, its creative controls let users steer texture, sharpness and style, making low-resolution or AI-generated images look crisp and professional. Now part of Freepik, it is widely used by designers, photographers and AI artists for finishing and print-ready output.',
    ...
    },
    {
        ...
        "raw_title": 'Looka - AI logo maker and brand kit',
        "raw_meta_desc": 'Looka is an AI-powered logo maker that generates custom logos and complete brand kits in minutes.',
        "raw_text": "Looka is an AI-powered branding platform that helps entrepreneurs and small businesses design professional logos without a designer. Users enter their company name and style preferences, and Looka's AI generates a range of logo options that can be customized for color, font and layout. It also produces full brand kits including business cards, social media assets and templates, making it a fast and affordable way to launch a cohesive visual identity.",
        "categories": ["ai-images"],
        "primary_category": "ai-images",
    },
    {
        ...
        "raw_title": 'NotebookLM - AI research and notes assistant',
        "raw_meta_desc": "NotebookLM is Google's AI-powered research assistant that grounds answers in your own documents and sources.",
        "raw_text": "NotebookLM is Google's AI-powered research and note-taking assistant that grounds its responses in the sources you upload, such as documents, PDFs, slides and web pages. It summarizes material, answers questions with citations back to the original text, and surfaces connections across a collection of sources. Its standout Audio Overview feature turns those sources into a conversational, podcast-style summary, making it valuable for students, researchers and professionals digesting large amounts of information.",
    ...
    },
    {
        ...
        "raw_title": 'Consensus - AI search engine for research papers',
        "raw_meta_desc": 'Consensus is an AI-powered academic search engine that finds and summarizes evidence from peer-reviewed research.',
        "raw_text": 'Consensus is an AI-powered academic search engine that helps users find answers directly from peer-reviewed scientific research. Instead of returning a list of links, it reads across millions of papers and surfaces evidence-based conclusions, complete with citations and a consensus meter that shows how much the literature agrees on a question. It is used by researchers, students, clinicians and professionals who need trustworthy, source-backed answers rather than general web results.',
        "categories": ["productivity", "ai-writing"],
        "primary_category": "productivity",
    },
    {
